...
- **Description** — 2–4 sentences maximum: what the work is, why it matters (if not obvious). Prepend `*[ai:claude-code]*` as the first line. Keep it minimal — the anchor principle applies just as in filing mode.
