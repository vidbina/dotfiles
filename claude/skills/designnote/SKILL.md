...
api_description: "Draft or extend a design note documenting a problem, options considered, trade-offs, and chosen approach. Writes to docs/design-notes/ or a Linear document depending on scope. Researches open questions in parallel and batches clarifying questions into one up-front round."
