...

{
  home.file."Applications/Gnoo.app".source = pkgs.stdenv.mkDerivation {
    ...
    installPhase = ''
      ...
      cp ${pkgs.my-emacs}/Applications/Emacs.app/Contents/Resources/Emacs.icns $out/Contents/Resources/ || true
      cp ${pkgs.my-emacs}/Applications/Emacs.app/Contents/Resources/document.icns $out/Contents/Resources/ || true
      ...
      <plist version="1.0">
        <dict>
      	...
      	<dict>
      	  <key>default</key>
      	  <string>Gnoo.app/New Buffer Containing Selection</string>
      	</dict>
      	<key>NSMessage</key>
      	...
      	<dict>
      	  <key>default</key>
      	  <string>Gnoo.app/Open Selected File</string>
      	</dict>
      	<key>NSMessage</key>
      	<string>requestService</string>
      	<key>NSUserData</key>
      	...
      	<dict>
      	  <key>default</key>
      	  <string>Gnoo.app/Email Selection</string>
      	</dict>
      	<key>NSMessage</key>
      	<string>requestService</string>
      	<key>NSUserData</key>
      	...
      	<dict>
      	  <key>default</key>
      	  <string>Gnoo.app/Send Email to Selected Address</string>
      	</dict>
      	<key>NSMessage</key>
      	<string>requestService</string>
      	<key>NSUserData</key>
          ...
          <string>Alias to Emacs</string>
          <key>CFBundleIconFile</key>
          <string>Emacs.icns</string>
          <key>CFBundleIdentifier</key>
          <string>me.vidbina.Gnoo</string>
          ...
          <string>Gnoo requires permission to send AppleEvents to other applications.</string>
          ...
          <string>Gnoo requires permission to access the Desktop folder.</string>
          <key>NSDocumentsFolderUsageDescription</key>
          <string>Gnoo requires permission to access the Documents folder.</string>
          <key>NSDownloadsFolderUsageDescription</key>
          <string>Gnoo requires permission to access the Downloads folder.</string>
          <key>NSRemovableVolumesUsageDescription</key>
          <string>Gnoo requires permission to access files on Removable Volumes.</string>
        </dict>
      </plist>
      EOF
